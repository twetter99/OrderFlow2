...
const LOGGED_IN_USER_ID = 'WF-USER-001';
...
const validTransitions: { [key in PurchaseOrder['status']]: PurchaseOrder['status'][] } = {
    ...
    'Recibida': [],
    'Recibida Parcialmente': ['Recibida', 'Recibida Parcialmente'],
};
...
interface PurchasingClientPageNewProps {
...
export function PurchasingClientPageNew({
