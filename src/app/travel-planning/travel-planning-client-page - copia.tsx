...
export function TravelPlanningClientPage({ initialReports, projects, technicians }: ClientPageProps) {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Si hay detalles adicionales (eliminación múltiple)
  ...
  // Contar cuántos informes aprobados hay en la selección
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Sheet para crear nuevo informe */}
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        <SheetContent className="w-full sm:max-w-3xl overflow-y-auto">
          <SheetHeader className="mb-4">
            <SheetTitle>Nuevo Informe de Viaje</SheetTitle>
            <SheetDescription>
