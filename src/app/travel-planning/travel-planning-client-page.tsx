...
export function TravelPlanningClientPage({ initialReports, projects, technicians }: ClientPageProps) {
  ...
  const confirmApprove = async () => {
    ...
    // Verificar el código de aprobación
    if (approvalCode !== '0707') {
      toast({ 
        variant: 'destructive', 
        title: 'Código incorrecto', 
        description: 'El código de aprobación no es válido.' 
      });
      setApprovalCode("");
      return;
    }
    ...
    <div className="flex flex-col gap-8">
      ...
      <AlertDialog open={isApproveDialogOpen} onOpenChange={setIsApproveDialogOpen}>
        <AlertDialogContent>
          ...
          <div className="py-4">
            <Label htmlFor="approval-code">Código de Aprobación *</Label>
            <Input
              id="approval-code"
              type="password"
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={confirmApprove} disabled={loading || !approvalCode.trim()}>
